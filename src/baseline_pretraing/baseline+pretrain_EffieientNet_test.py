...
model.load_state_dict(torch.load("/models/baseline+pretrain_EfficientNet_XXX_{epoch}.pth"))
...
csv_file = './results/test_baseline+pretrain_EfficientNet_XXX_pred.csv'
