...
criterion = WeightedLoss(alpha=0.1)
...
model.load_state_dict(torch.load(f'./models/baseline_pretrain_ACELoss_VGG_XXX.pth'))
...
csv_file = './results/test_baseline_pretrain_ACELoss_VGG_XXX_pred.csv'
