...
def Draw_loss(losses):
    ...
    plt.xlabel('Epoch')
    plt.ylabel('Loss')
    plt.savefig("./results/loss_baseline_pretrain_ACELoss_MobieNet_XXX.pdf")
...
for epoch in range(150):
    ...
    if epoch > 140:
        save_folder = './models'
        save_path = os.path.join(save_folder, f'baseline_pretrain_ACELoss_MobieNet_XXX_{epoch}.pth')
        ...
        csv_filename = './results/baseline_pretrain_ACELoss_MobieNet_XXX.csv'
