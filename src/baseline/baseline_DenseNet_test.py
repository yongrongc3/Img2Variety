...
for epoch in range(141, 142):
    model.load_state_dict(torch.load(f'./models/baseline_Densenet_XXX_{epoch}.pth'))
    model.eval()
    test_loss = 0.0
    test_acc = 0.0
    image_names = []
...
csv_file = './results/test_baseline_Densenet_XXX_pred_epochxxx.csv'
