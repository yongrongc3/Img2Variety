...
def Draw_loss(losses):
    ...
    plt.xlabel('Epoch')
    plt.ylabel('Loss')
    plt.savefig("./results/loss_Image2ID_MobieNet.pdf")
...
for epoch in range(150):
    ...
    if epoch > 140:
        save_folder = './models'
        save_path = os.path.join(save_folder, f'Image2ID_MobieNet_{epoch}.pth')
        ...
        csv_filename = './results/Image2ID_MobieNet.csv'
